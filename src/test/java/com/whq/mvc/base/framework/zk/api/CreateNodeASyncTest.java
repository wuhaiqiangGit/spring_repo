package com.whq.mvc.base.framework.zk.api;
...
public class CreateNodeASyncTest implements Watcher {
    ...
    @Test
    public void testCreateNodeAsync() throws IOException, InterruptedException {
        zooKeeper = new ZooKeeper("192.168.1.108:2181", 5000, new CreateNodeASyncTest());
